...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-semibold text-gray-700 mb-6">Create New Role</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    @forelse ($permissions as $id => $name)
                        <div class="flex items-center">
                            <input type="checkbox" name="permissions[]" id="permission_{{ $id }}" value="{{ $name }}" class="form-checkbox h-5 w-5 text-blue-600">
